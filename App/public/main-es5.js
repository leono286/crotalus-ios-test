(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_storageKeys_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    let AppComponent = class AppComponent {
      constructor(platform, storage, searchService) {
      ...
      shouldSetDarkMode() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          yield this.storage.get(_models_storageKeys_enum__WEBPACK_IMPORTED_MODULE_2__["StorageKeys"].darkMode).then(val => {
            if (val) {
              ...
              this.storage.set(_models_storageKeys_enum__WEBPACK_IMPORTED_MODULE_2__["StorageKeys"].darkMode, defaultDarkModeSettings);
            }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], _ionic_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"], _services_search_service__WEBPACK_IMPORTED_MODULE_1__["SearchService"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_11__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_8__["IonicStorageModule"].forRoot()],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_7__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_6__["SplashScreen"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_13__["SocialSharing"], _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_14__["FileTransfer"], _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_15__["File"], {
  ...
  /*! exports provided: getItemTypeLabel, getItemTypeIcon, getSizeLabel, getResourceType */
  ...
  function srcAppHelpersTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "getItemTypeLabel", function () {
      return getItemTypeLabel;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "getItemTypeIcon", function () {
      return getItemTypeIcon;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "getSizeLabel", function () {
      return getSizeLabel;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "getResourceType", function () {
    ...
    const getItemTypeLabel = (itemType, plural) => {
      switch (itemType) {
    ...
    const getResourceType = resource => {
      if (_models_search_type_enum__WEBPACK_IMPORTED_MODULE_1__["DocumentFormats"].includes(resource.metadata.technical.format)) {
        return 'document';
      } else {
  ...
  /***/
  "./src/app/models/licenses.const.ts":
  /*!******************************************!*\
    !*** ./src/app/models/licenses.const.ts ***!
    \******************************************/
  ...
  /***/
  function srcAppModelsLicensesConstTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LICENSES", function () {
      return LICENSES;
    });
    /* harmony import */
    ...
    const LICENSES = [{
      ...
      imagePath: '/assets/img/licenses/cc0.png',
      stringFilter: '("cc0")'
    }, {
      value: 'by',
      description: 'Atribución',
      imagePath: '/assets/img/licenses/by.png',
      stringFilter: '("by"!"by-sa"!"by-nd"!"by-nc")'
    }, {
      value: 'by-sa',
      description: 'Atribución - Compartir igual',
      imagePath: '/assets/img/licenses/by-sa.png',
      stringFilter: '("by-sa")'
    }, {
      value: 'by-nd',
      description: 'Atribución - Sin derivadas',
      imagePath: '/assets/img/licenses/by-nd.png',
      stringFilter: '("by-nd")'
    }, {
      value: 'by-nc',
      description: 'Atribución - No comercial',
      imagePath: '/assets/img/licenses/by-nc.png',
      stringFilter: '("by-nc"!"by-nc-sa")'
    }, {
      value: 'by-nc-sa',
      description: 'Atribución - No comercial - Compartir igual',
      imagePath: '/assets/img/licenses/by-nc-sa.png',
      stringFilter: '("by-nc-sa")'
    }, {
      value: 'by-nc-nd',
      description: 'Atribución - No comercial - Sin derivadas',
      imagePath: '/assets/img/licenses/by-nc-nd.png',
      stringFilter: '("by-nc-nd")'
    ...
    // Creative Commons Atribución, Sin derivadas
    // Dominio público
  ...
  /*! exports provided: SearchTypes, DocumentFormats */

  /***/
  function srcAppModelsSearchTypeEnumTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SearchTypes", function () {
      return SearchTypes;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "DocumentFormats", function () {
    ...
    (function (SearchTypes) {
      SearchTypes["all"] = "all";
      SearchTypes["image"] = "image";
      SearchTypes["video"] = "video";
      SearchTypes["audio"] = "audio";
      SearchTypes["document"] = "document";
      SearchTypes["didacticUnit"] = "didacticUnit";
    })(SearchTypes || (SearchTypes = {}));

    const DocumentFormats = ['application/msword', 'application/pdf', 'application/rtf', 'text/html', 'text/plain'];
    /***/
  },
  ...
  /***/
  function srcAppModelsStorageKeysEnumTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function (StorageKeys) {
      StorageKeys["darkMode"] = "darkMode";
      StorageKeys["defaultSearchType"] = "defaultSearchType";
      StorageKeys["connectedRepositories"] = "connectedRepositories";
      StorageKeys["availableRepositories"] = "availableRepositories";
  ...
  function srcAppServicesSearchServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_licenses_const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./../models/licenses.const */
    "./src/app/models/licenses.const.ts");
    /* harmony import */
    ...
    var _models_storageKeys_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./../models/storageKeys.enum */
    "./src/app/models/storageKeys.enum.ts");
    /* harmony import */
    ...
    let SearchService = class SearchService {
      constructor(http, storage) {
        this.http = http;
        this.storage = storage;
        this.reposConnectedNumber$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__["BehaviorSubject"](0);
        this.licenses$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__["BehaviorSubject"]([]);
        this.defaultSearchChangedInSettings = false;
        this.options = {
          resultsResponseSize: 20,
          minLetters: 3
        };
        this.updateReposConnectedNumber();
        this.licenses = _models_licenses_const__WEBPACK_IMPORTED_MODULE_1__["LICENSES"].map(license => Object.assign({}, license, {
          active: true
        }));
      ...
      getConnectedRepositories() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          this.repositories = yield this.storage.get(_models_storageKeys_enum__WEBPACK_IMPORTED_MODULE_3__["StorageKeys"].connectedRepositories);
        });
      }

      isThereAnyRepositoryConnected() {
        return this.repositories && this.repositories.length > 0;
      }

      search(value, firstCall, searchType) {
        if (firstCall) {
      ...
      createSearchRequest(value) {
        const requestToPerform = this.repositories.map(repository => {
          return this.http.get(this.createRepositoryRequestUrl(value, repository)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(singleRepoResults => {
            return singleRepoResults.map(result => {
              result.type = Object(_helpers__WEBPACK_IMPORTED_MODULE_9__["getResourceType"])(result);
              result.repositoryName = repository.name;
              return result;
            });
          }));
        });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["forkJoin"])([...requestToPerform]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(results => {
          this.apiRequestsCounter += 1;
        }));
      }

      createRepositoryRequestUrl(value, repository) {
        const repoCatalogues = repository.catalogs.map(catalog => catalog.key).join('|');
        return "".concat(repository.api, "c/[").concat(repoCatalogues, "]/resources.json?q=").concat(value, "&").concat(this.generateRequestParams());
      }

      generateRequestParams() {
        const responseSize = this.options.resultsResponseSize;
        const resultsOffset = responseSize * this.apiRequestsCounter;
        const searchParams = "(n)=".concat(responseSize, "&(s)=").concat(resultsOffset);
        const filters = this.typesToSearchQueryString;
        const generatedRequestParams = this.includeLicenses ? "".concat(searchParams).concat(filters ? '&' + filters : '', "&").concat(this.licensesFilterParam) : "".concat(searchParams).concat(filters ? '&' + filters : '');
        return generatedRequestParams;
      }

      getResourceAbout(about) {
        return this.http.get(about);
      }

      setLicensesFilterForSearch() {
        const arrayOfActiveSelectors = this.licenses.reduce((activeLicenses, license) => {
        ...
        this.licensesFilterParam = "(meta)[metadata.rights.copyright]=".concat(value);
      }

      setTypeFilterForSearch(searchType) {
        const metadataType = 'metadata.technical.format';

        if (searchType === _models_search_type_enum__WEBPACK_IMPORTED_MODULE_2__["SearchTypes"].all) {
          this.typesToSearchQueryString = '';
        } else if (searchType === _models_search_type_enum__WEBPACK_IMPORTED_MODULE_2__["SearchTypes"].document) {
          this.typesToSearchQueryString = _models_search_type_enum__WEBPACK_IMPORTED_MODULE_2__["DocumentFormats"].reduce((prevValue, actualItem, index) => {
            return prevValue + (index !== 0 ? '&' : '') + "(meta)[".concat(metadataType, "][").concat(index, "]=\"").concat(actualItem, "\"");
          }, '');
        } else if (searchType === _models_search_type_enum__WEBPACK_IMPORTED_MODULE_2__["SearchTypes"].didacticUnit) {
          this.typesToSearchQueryString = '(meta)[metadata.educational.learning_resource_type]="temathic unit"';
        } else {
          this.typesToSearchQueryString = "(meta)[".concat(metadataType, "]=").concat(searchType);
        }
      }

      updateActiveLicenses(filterValue, active) {
        const targetIndex = this.licenses.findIndex(({
          value
        }) => filterValue === value);
      ...
      getDefaultSearchChangedInSettings() {
        return this.defaultSearchChangedInSettings;
      }

      setDefaultSearchChangedInSettings(value) {
    ...
    SearchService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"], _ionic_storage__WEBPACK_IMPORTED_MODULE_6__["Storage"]])], SearchService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/leoperez/Documents/crotalus/crotalus-mobile-app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
